...
p2.children[0].innerText="€32.57";

//html da modificare per il prezzo in basso
var html2 = '<span class="inclusaiva"> iva inclusa</span>';
...
qty.onchange = function(){
	...
	v = parseInt(v);
	iva = (((0.89*v)*22)/100);
	document.querySelectorAll('p.price')[1].children[0].innerText="€"+Number(((0.89*v)+iva).toFixed(2));
